...
extract.results <- function(files,filenameextract=0,path.name,experiment_name,results){
...
generate.series <- function(experiment_name,path.name,results="biogem"){
  ...
  series$ocn <- extract.results(files,results=results,path.name=path.name,experiment_name=experiment_name)
  ...
  series$sed <- extract.results(files,results=results,path.name=path.name,experiment_name=experiment_name)
  ...
  series$focnsed <- extract.results(files,results=results,path.name=path.name,experiment_name=experiment_name)
  ...
  series$focnatm <- extract.results(files,filenameextract=0,results=results,path.name=path.name,experiment_name=experiment_name)
  ...
  series$fseaair <- extract.results(files,filenameextract=0,results=results,path.name=path.name,experiment_name=experiment_name)
  ...
  series$fsedocn <- extract.results(files,filenameextract=0,results=results,path.name=path.name,experiment_name=experiment_name)
  ...
  series$precip <- extract.results(files,filenameextract=1,results=results,path.name=path.name,experiment_name=experiment_name)
  ...
  series$react <- extract.results(files,filenameextract=2,results=results,path.name=path.name,experiment_name=experiment_name)
  ...
  series$redox <- extract.results(files,filenameextract=2,results=results,path.name=path.name,experiment_name=experiment_name)
  ...
  series$reminD <- extract.results(files,filenameextract=2,results=results,path.name=path.name,experiment_name=experiment_name)
  ...
  series$reminP <- extract.results(files,filenameextract=2,results=results,path.name=path.name,experiment_name=experiment_name)
  ...
  series$weather <- extract.results(files,filenameextract=0,results=results,path.name=path.name,experiment_name=experiment_name)
  ...
  series$fexport <- extract.results(files,filenameextract=0,results=results,path.name=path.name,experiment_name=experiment_name)
...
plot.timeseries <- function(time,value,y.lim=NULL,x.axis=T,lett=NULL,name=NULL,factor=1){
  
  if (is.null(y.lim)){
    y.min <- min(as.numeric(value))*factor
    if (y.min<0){y.min <- y.min*1.01}else{y.min <- y.min*0.99}
    
    y.max <- max(as.numeric(value))*factor
  ...
  plot(x=time, y=as.numeric(value)*factor,pch=16,col="black",axes=F,xlab="",ylab="",
       xlim=range(as.numeric(time)),ylim=y.lim,type="b")
